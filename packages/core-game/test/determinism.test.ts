...
describe("симуляция", () => {
  ...
  it("совпадает с эталонной контрольной суммой забега", () => {
    ...
    // Эталон обновлён вместе со ступенями врагов и вороньём. Ступени делают
    // врагов крепче по ходу забега, вороны быстрее игрока и не отпускают:
    // за ту же минуту забег убивает 311 против 685 и берёт 15-й уровень
    // вместо 21-го.
    expect(run.checksum).toBe(1620385539);
