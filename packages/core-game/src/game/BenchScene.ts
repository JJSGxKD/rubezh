...
export class BenchScene extends Phaser.Scene {
  ...
  private buildControls(): void {
    // Каждая кнопка задаёт режим И нагрузку. Меняй «Ramp» только режим, она
    // наследовала бы популяцию предыдущего профиля: после нажатия «100»
    // нарастающий прогон упирался бы в потолок 100 и переставал нарастать.
    this.addButton("Ramp", () =>
