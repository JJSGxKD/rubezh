 ...
 *
 * **Все числа — рабочие** (Р31, открытые О1 и О2): стоят до решения по
 * экономике и меняются здесь, в карте конфигурации —
 * docs/30-configuration-map.md. Ориентир — медиана живого забега 6–10 минут
