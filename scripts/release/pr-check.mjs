...
/**
 * Области, до игрока не доходящие: инструменты разработчика. Версия всё равно
 * поднимается — монорепо выпускается одним номером, и собрать сборку из тега
 * нужно любой, — но на патч, а не на минор: иначе правка dev-сервера двигает
