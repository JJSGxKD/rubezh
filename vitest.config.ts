...
export default defineConfig({
  test: {
    ...
    // это умолчание Vitest, и отдельной настройки оно больше не требует.
    // Раньше здесь стоял `poolOptions.forks.singleFork: false`, который
    // повторял умолчание; в Vitest 5 такого поля нет вовсе.
  },
  resolve: {
    alias: {
