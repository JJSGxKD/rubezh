...
export default defineConfig({
  test: {
    ...
    // Тесты не зависят друг от друга и от порядка (docs/17-testing-strategy.md §10),
    // поэтому файлы гоняются параллельно. Исключение — бюджет
    // производительности: он меряет время и живёт в своём пуле (см. ниже).
    poolOptions: {
