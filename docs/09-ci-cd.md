...
|---|---|---|
| `ci.yml` | PR, push в `main` | Гейт §2 и сборка образа бэкенда без публикации; на push в `main` — джоб релиза §8.1: версия, образ в GHCR, тег, GitHub Release с архивом статики. Сборка матрицы §1 — ещё не реализована |
