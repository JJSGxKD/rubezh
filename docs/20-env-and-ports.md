...
`/api/v1/wallet`, `/api/v1/playtest`, приёмники, отзывы и вебхук бота на
...
оплата, кошелёк и плейтест — токеном сессии. Роли, журнал и остальные эндпоинты dev-бэкенда
