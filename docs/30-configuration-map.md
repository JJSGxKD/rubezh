...
| Воронка аккаунта: граница суток для возвратов D1 и D7 — Москва, как у всех суточных механик (`05-game-design.md` §3) | `backend/api/src/modules/funnel/funnel.repository.ts` → `FUNNEL_TIME_ZONE` | участник 1 |
